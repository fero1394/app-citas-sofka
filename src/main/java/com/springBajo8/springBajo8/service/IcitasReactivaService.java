...
public interface IcitasReactivaService {
    ...
    Flux<citasDTOReactiva> findByFechaReservaCita(String fechaCita);

    Flux<citasDTOReactiva> findByHoraReservaCita(String horaCita);

    Mono<citasDTOReactiva> findByNombreMedico(String id);
}
