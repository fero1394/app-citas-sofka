...
public class citasReactivaResource {
    ...
    @GetMapping("/citasReactivas/{fechaCita}/byfechaCita")
    private Flux<citasDTOReactiva> findAllByfechaCita(@PathVariable("fechaCita") String fechaCita) {
        return this.icitasReactivaService.findByFechaReservaCita(fechaCita);
    }

    @GetMapping("/citasReactivas/{horaCita}/byhoraCita")
    private Flux<citasDTOReactiva> findAllByhoraCita(@PathVariable("horaCita") String horaCita) {
        return this.icitasReactivaService.findByHoraReservaCita(horaCita);
    }
}
